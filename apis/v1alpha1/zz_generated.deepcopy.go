...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPRequestAuthorization) DeepCopyInto(out *HTTPRequestAuthorization) {
	*out = *in
	if in.FailModeAllow != nil {
		in, out := &in.FailModeAllow, &out.FailModeAllow
		*out = new(bool)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPRequestAuthorization.
func (in *HTTPRequestAuthorization) DeepCopy() *HTTPRequestAuthorization {
	if in == nil {
		return nil
	}
	out := new(HTTPRequestAuthorization)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HTTPRouteFilter) DeepCopyInto(out *HTTPRouteFilter) {
	*out = *in
	...
	if in.RequestAuthorization != nil {
		in, out := &in.RequestAuthorization, &out.RequestAuthorization
		*out = new(HTTPRequestAuthorization)
		(*in).DeepCopyInto(*out)
	}
